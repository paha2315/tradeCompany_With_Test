CREATE DATABASE  IF NOT EXISTS `course_work` /*!40100 DEFAULT CHARACTER SET cp1251 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `course_work`;
...
INSERT INTO `availability` VALUES (17,2,1,1,1,20,750,'Коробка',0.2,0.05,0.06),(18,2,1,1,1,4,799,'Коробка',0.2,0.05,0.06),(19,1,1,2,1,24,2499,'Коробка',0.4,0.25,0.3),(20,3,1,3,1,3,600,'Мелкий пакет',0.08,0.08,0.02),(21,4,1,3,2,72,1399,'Коробка',0.3,0.4,0.3),(22,4,1,3,2,3,1700,'Коробка',0.3,0.4,0.3),(23,4,1,3,2,5,1432.59,'Коробка',0.3,0.4,0.3),(24,1,2,1,1,24,2799,'Коробюка',0.4,0.2,0.25);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `DelAvailability` BEFORE DELETE ON `availability` FOR EACH ROW BEGIN
  delete from availability_link
    where availability_link.ID_Availability = old.ID_Availability;
END */;;
DELIMITER ;
...
INSERT INTO `availability_link` VALUES (17,20,17,20),(18,20,18,11),(19,20,19,35),(20,21,20,15),(21,21,21,76),(22,22,20,-12),(23,23,18,-7),(24,24,21,-4),(25,25,19,-11),(26,26,22,3),(27,27,23,5),(28,28,24,24);
...
INSERT INTO `document` VALUES (20,'2023-06-27'),(21,'2023-07-01'),(22,'2023-06-29'),(23,'2023-06-26'),(24,'2023-06-30'),(25,'2023-06-28'),(26,'2023-06-29'),(27,'2023-06-29'),(28,'2023-06-29');
...
INSERT INTO `orders` VALUES (26,20,2,1,750,20,5),(27,20,2,1,799,11,5),(28,20,3,1,2499,35,5),(29,21,4,1,600,15,4),(30,21,5,1,1399,76,4),(31,25,2,1,1,11,6),(32,22,2,1,3,12,6),(33,23,2,1,2,7,6),(34,24,2,1,4,4,6),(35,26,5,1,1700,3,5),(36,27,5,1,1432.59,5,5),(37,28,3,2,2799,24,5),(38,NULL,5,1,1,10,2);
...
INSERT INTO `person` VALUES (1,3,NULL,'Администратор','Главный','','admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918'),(2,2,NULL,'Всеволод','Петров','Дмитриевич','petrov123','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3'),(3,1,2,'Николай','Комаров','Григорьевич','komarov234','114bd151f8fb0c58642d2170da4ae7d7c57977260ac2cc8905306cab6b2acabc'),(4,2,NULL,'Sergay','Smirnov','','smirnov321','8d23cf6c86e834a7aa6eded54c26ce2bb2e74903538c61bdd5d2197997ab2f72'),(6,1,3,'Антон','Орлов','Максимович','orlov123','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3'),(7,1,4,'Иван','Новиков','Робертович','novikov123','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3'),(8,1,5,'Александр','Пушкин','Сергеевич','pushkin111','f6e0a1e2ac41945a9aa7ff8a8aaa0cebc12a3bcc981a929ad5cf810a090e11ae'),(9,1,NULL,'a','a','a','a','ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `DelProduct` BEFORE DELETE ON `product` FOR EACH ROW BEGIN
  Delete from availability
    where availability.ID_Product = old.ID_Product;
    delete from supplier
    where supplier.ID_Product=old.ID_Product;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `supplier` VALUES (2,2,'ЗАО АксессуарыДляТелефонов','Сыктывкар','г. Сыктывкар, ул. Мелиораторов, д. 1',10000002,'6820672856026718','111(45)037-22-37','167014','СыкТывБанк'),(3,1,'ООО МодаОнлайн','Санкт-Петербург','г. Санкт-Петербург, ул. Коллонтай, д.3, к. 4',10000000,'01234567890123456789','8(800)555-35-35','191919','ВТБ'),(4,3,'ОАО АкумПром','Сыктывкар','г. Сыктывкар, ул. Тентюковская улица, д. 188',10000001,'4235465768899804','6(40)246-59-42','167014','Сбербанк'),(5,4,'ЗАО Кипяточка','Рыбинск','г. Рыбинск, ул. Луначарского, д. 27',10003632,'8233545087834317','7(4855)994-45-38','152934','Русский Стандарт');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `DelSupplier` BEFORE DELETE ON `supplier` FOR EACH ROW BEGIN
  delete from orders
    where orders.ID_Supplier = old.ID_Supplier;
    delete from person
    where person.ID_Supplier=old.ID_Supplier;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-06-29 11:48:18
